...
def main():
    ...
    # The cursor() method of the connection object creates a cursor object that
    # can be used to execute a statement or navigate through a result set:
    ...
    dbhelper_conn = Psycopg2Connection(
        db='defaultdb',
        user='root',
        host='guy13',
        port=26257
